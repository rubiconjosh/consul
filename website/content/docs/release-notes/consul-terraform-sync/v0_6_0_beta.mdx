...
## CTS Self Registration With Consul
In 0.6.0, CTS will be able to automatically register itself to Consul. To help support this, in 0.6.0, CTS will support a health endpoint which Consul can use to evaluate the health of the CTS instance.
